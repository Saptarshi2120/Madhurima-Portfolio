...
const fallbackResponses = [
  ...
  "Hmm, that's a unique perspective! Speaking of unique, check out my portfolio projects to see my creative approach to problem-solving.",
  ...
  "That's something I'd love to discuss over coffee! In the meantime, feel free to check out my work or download my resume.",
